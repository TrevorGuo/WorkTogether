...
To run this repo on your computer open terminal and navigate to the directory you want the app to be in.
Type in terminal:
git clone https://github.com/TrevorGuo/35LProject.git

Then:
cd 35LProject/project-react

Then install the node dependencies by running:
npm install
